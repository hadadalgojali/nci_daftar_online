...
// 			$oM['code']=$oO->getUnitCode();
	...
	public function getList(){
		...
		for($i=0,$iLen=count($res['data']); $i<$iLen; $i++){
			...
			if ($r->getjenis_kunjungan_bpjs() == 0 || $r->getjenis_kunjungan_bpjs() == '0') {
				$o['f12']= "Umum";
			}else if($r->getjenis_kunjungan_bpjs() == 1 || $r->getjenis_kunjungan_bpjs() == '1'){
				$o['f12']= "Episode Baru";
			}else{
				$o['f12']= "Episode Lanjutan";
			}

			// $o['f12']=$r->getjenis_kunjungan_bpjs();
			...
			if ($r->getKodeSep() != null || $r->getKodeSep() != 'null') {
				$o['f11'] = $r->getKodeSep();
			}else{
				$o['f11'] = "";
			}
