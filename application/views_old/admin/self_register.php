...
<marquee>Selamat Datang di <?php echo $tenant->getTenantName(); ?>, Ini adalah Fasilitas Konfirmasi / Self Register Pendaftaran Online, Untuk Pendaftaran Online anda bisa mengunjungi Website Kami,
Silahkan Kunjungi Website Kami www.rssoedono.jatimprov.go.id, Pendaftaran Online berlaku hanya untuk Pasien Umum dan Pasien Yang Sudah Terdaftar di 
	...
	<div id="div-confirm" style="display: none;margin-left: auto; margin-right: auto;width: 500px;">
		...
		$(function(){
			...
			//$('#read').html(data);
				...
				batal=false;
				$.ajax({
					url:'<?php echo base_url(); ?>app/rs2/getNomorPendaftaran?noRegister='+data,
			...
			var URL = "http://localhost:85/rssm_online/app/rs2/setNomorPendaftaran/"+noregis+"/jenis_pasien/"+kel_pasien+"/";
