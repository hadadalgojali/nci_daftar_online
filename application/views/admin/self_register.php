...
<head>
	...
	<script src="<?php echo base_url()?>vendor/PrinterService.js"></script>
	<style>
		.form-group{
			font-size:18px;
		}
...
<div class="container" style="padding-top: 50px;">
	...
	<div  id="div-output" style="display: none;margin-left: auto; margin-right: auto;width: 700px;">
		...
		<div class="form-group row">
			...
			<div class="col-md-8" id="t-nama" style="margin-top:-15px">
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-md-8" id="t-tgllahir" style="margin-top:-15px">
			</div>
		</div>	
	<!-- </div> -->
	...
	<!-- <div  id="div-output2" style="display: none;margin-left: auto; margin-right: auto;width: 700px;"> -->
		<div class="form-group row">
			...
			<div class="col-md-8" id="kelompok_pasien" style="margin-top:-15px">
			</div>
		</div>

		<div class="form-group row" id="row_no_peserta" id="row_no_peserta" style="display:none;">
			<div class="col-md-4" style="margin-top:-15px">
				<label for="t-nama">No Peserta :</label>
			</div>
			<div class="col-md-8" id="no_peserta" style="margin-top:-15px">
			</div>
		</div>

		<div class="form-group row" id="row_no_rujukan" style="display:none;">
			<div class="col-md-4"style="margin-top:-15px">
				<label for="t-tgllahir">No Rujukan :</label>
			</div>
			<div class="col-md-8" id="no_rujukan" style="margin-top:-15px">
			</div>
		</div>	

		<div class="form-group row" id="row_kelas_rujukan" style="display:none;">
			<div class="col-md-4" style="margin-top:-15px">
				<label for="t-tgllahir" >Kelas :</label>
			</div>
			<div class="col-md-8" id="kelas" style="margin-top:-15px">
			</div>
		</div>

		<div class="form-group row" id="row_faskes_asal" style="display:none;">
			<div class="col-md-4" style="margin-top:-15px">
				<label for="t-tgllahir">Faskes Asal :</label>
			</div>
			<div class="col-md-8" id="faskes_asal" style="margin-top:-15px">
			</div>
		</div>

		<div class="form-group row" id="row_poli_rujukan" style="display:none;">
			<div class="col-md-4" style="margin-top:-15px">
				<label for="t-tgllahir">Poliklinik Tujuan :</label>
			</div>
			<div class="col-md-8" id="poli_tujuan" style="margin-top:-15px">
			</div>
		</div>	
		
		<div class="form-group row" id="row_diagnosa_rujukan" style="display:none;">
			<div class="col-md-4" style="margin-top:-15px">
				<label for="t-tgllahir">Diagnosa :</label>
			</div>
			<div class="col-md-8" id="diagnosa" style="margin-top:-15px">
			</div>
		</div>	
		...
		<div class="form-group row">
			...
			<div class="col-md-8" id="dokter" style="margin-top:-15px">
			</div>
		...
		$(function(){
			...
			$('#btnYa').bind('click',function(){
				...
				$.ajax({
					...
					type:'GET',
					dataType:'JSON',
					success:function(r){  //IP PC TRACER//
						var cmd = "doPrint#\\\\192.168.0.27\\LX310_NEW#"+r.response; 
						ws.send(cmd);
						console.log(cmd);
						$('#div-loading').hide();
						/*console.log(r);*/
						if(r.response == false || r.response == 'false'){
							if(kel_pasien == '1'){
					...
					error:function(jqXHR, exception){
						...
						var cmd = "doPrint#//192.168.0.27/LX310_NEW#"+jqXHR.response; 
						ws.send(cmd);
						console.log(cmd);
						resetAll();
					}
					...
					success:function(r){
						if(r.result=='SUCCESS'){
							if(batal==false){
								...
								if(kelompok_pasien=='BPJS PBI' || kelompok_pasien=='BPJS NON PBI'){
									console.log('bpjs');
								    document.getElementById("row_no_peserta").style.display='block';
								    document.getElementById("row_no_rujukan").style.display='block';
								    document.getElementById("row_kelas_rujukan").style.display='block';
								    document.getElementById("row_faskes_asal").style.display='block';
								    document.getElementById("row_poli_rujukan").style.display='block';
								    document.getElementById("row_poli_rujukan").style.display='block';
								    document.getElementById("row_diagnosa_rujukan").style.display='block';
								}else{
									console.log('bukan');
									document.getElementById("row_no_peserta").style.display='none';
									document.getElementById("row_no_rujukan").style.display='none';
								    document.getElementById("row_kelas_rujukan").style.display='none';
								    document.getElementById("row_faskes_asal").style.display='none';
								    document.getElementById("row_poli_rujukan").style.display='none';
								    document.getElementById("row_poli_rujukan").style.display='none';
								    document.getElementById("row_diagnosa_rujukan").style.display='none';
								}	
							}
						}else{
							$('#div-loading').hide();
