...
<marquee>Selamat Datang di <?php echo $tenant->getTenantName(); ?>, Ini adalah Fasilitas Konfirmasi / Self Check In, Untuk Pendaftaran Online anda bisa mengunjungi Website Kami,
Silahkan Kunjungi Website Kami registrasi.rssuakainsan.com, Pendaftaran Online berlaku hanya untuk Pasien Umum dan Pasien Yang Sudah Terdaftar di 
...
<div class="container" style="padding-top: 50px;">
	...
	<div id="div-confirm" style="display: none;margin-left: auto; margin-right: auto;width: 500px;">
		...
		$(function(){
			...
			//var URL = "http://demo.nci.co.id/registrasi-online/index.php/app/rs2/setNomorPendaftaran/"+noregis+"/jenis_pasien/"+kel_pasien+"/";
