								...
								<div class="col-md-6">
									...
									<div class="form-group row">
										...
										<div class="col-md-8">
											...
											<input type="text"  maxlength="26" class="form-control" id="no_kartu_bpjs" value="" name="no_kartu_bpjs"   style="display:none;"> 
					...
					dataType: 'json',
						...
						success: function(data) {
							...
							if(status=='200'){
								...
								$('#no_kartu_bpjs').val(data.resp.response.rujukan.peserta.noKartu);
