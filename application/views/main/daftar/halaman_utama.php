		...
		<div class="menu-left-head">
			...
			<div class="menu-left" style="padding: 0px !important;">
					...
					<div style="margin: 15px; padding-top:15px; padding-bottom:15px;">
						...
						1. Pendaftaran online dapat dilakukan saat hari kunjung maksimal jam 13:30 dan 1 (satu) hari sebelum kunjungan. <br>
						2. Pembayaran biaya pendaftaran untuk pasien umum dilakukan di loket kasir yang berlokasi di Rumah Sakit. <br>
						3. Untuk pasien BPJS harus ada surat rujukan ke RS Soedono Madiun yang masih berlaku. <br>
						4. Untuk pasien BPJS, <strong>nama poli tujuan kunjungan</strong> harus sama dengan <strong>nama poli pada surat rujukan.</strong>  <br> 
						5. Untuk <strong>Pasien Hemodialisa</strong> silahkan datang langsung ke Loket Pendaftaran. <br> 
						<!-- 4. Untuk <strong>pasien BPJS Lanjutan dan BPJS Hemodialisa</strong> silahkan datang langsung ke Loket Pendaftaran. <br> -->
						<!-- 4. Pendaftaran online bisa dilakukan selama kuota masih ada. <br> -->
						6. Check in dapat dilakukan saat hari kunjungan pada jam 06:30 s/d 14:00. <br>
