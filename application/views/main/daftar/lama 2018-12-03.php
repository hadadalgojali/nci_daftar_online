...
<div class="row">
	...
	<div class="col-md-10">
		...
		<div class="menu-left-head">
			...
			<h3> <strong>Pasien</strong> Lama</h3>
			...
			<div class="menu-left" style="padding: 0px !important;">
				...
				<form id="form" class="form-signin" method="POST" autocomplete="off" action="<?php echo base_url()?>index.php/daftar/saveLama">
					...
					<div style="margin: 15px;">
						...
						1. Pendaftaran pasien lama untuk pasien yang sudah memiliki nomor Rekam Medis.<br>

						2. Pendaftaran online dilakukan paling lambat satu hari sebelum berkunjung ke rumah sakit atau (H-1).<br>

						3. Biaya pendaftaran (untuk pasien umum) di loket kasir yang berlokasi di Rumah Sakit.<br>

						4. Untuk pasien BPJS harus ada surat rujukan.<br>
							...
							<div class="row">
								...
								<div class="col-md-6">
									...
									<div class="form-group row" id="div_id_faskes_lama" style="display:none">
										...
										<div class="col-md-4">
											<input id="btn_cek_no_kartu_lama" type="button" class="btn btn-success"  style="display:none" value="Cek" onclick="javascript: cek_no_kartu();" />
										</div>
								...
								<div class="col-md-6">
									...
									<div class="form-group row">
										...
										<div class="col-md-4">
											...
											<label for="lbl_poli_lama" id="lbl_poli_lama" style="display:none">Poliklinik:</label>
