							...
							<div class="row">
								...
								<fieldset>
									...
									<div class="form-group row">
										...
										<div class="col-xs-8">
											<input type="text" class="form-control" id="txtMedrec"  name="txtMedrec" >
											...
											<script>
												function cariPasien(){
													...
													if($('#txtMedrec').val() !='' && $('#tgllahir').val() != ''){
														...
														alert('Harap isi Tgl. Lahir atau No. Medrec untuk melakukan pencarian!');
													}
												} 
											</script>
										</div>
											...
											<script type="text/javascript">
											  ...
											  $(function() {
												...
												?>
													...
													var bulan_tmp = ("0" + now.getMonth()+1).slice(-2);
													$('#tglReg').val(now.getDate()+'-'+bulan_tmp+'-'+now.getFullYear());
