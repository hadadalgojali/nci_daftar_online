...
<div class="row">
	...
	<div class="col-md-10">
		...
		<div class="menu-left-head">
			...
			<h3> <strong>SYARAT DAN KETENTUAN PENDAFTARAN ONLINE :</h3>
			...
			<div class="menu-left" style="padding: 0px !important;">
					...
					<div style="margin: 15px; ">
						...
						1. Pendaftaran online dapat dilkakukan pada 1 (satu) hari sebelum kunjungan pada jam 06.00-13.00. <br>
						2. Biaya pendaftaran (untuk pasien umum) di loket kasir yang berlokasi di Rumah Sakit. <br>
						3. Untuk pasien BPJS harus ada surat rujukan. <br>
						4. Pendaftaran online bisa dilkakukan selama kuota masih ada. <br>
 
						
					</div>

			</div><div class="menu-left" style="padding: 0px !important;"></div>

			<h4> <strong>Pendaftaran Pasien Baru</strong></h4>
			...
			<div class="menu-left" style="padding: 0px !important;">
					...
					<div style="margin: 15px; ">
						...
						Untuk pasien yang belum memiliki nomer rekam medis di RSUD Dr. Soedono Madiun. <br>
			...
			<h4> <strong>Pendaftaran Pasien Lama</strong></h4>
			...
			<div class="menu-left" style="padding: 0px !important;">
					...
					<div style="margin: 15px;">
						...
						Untuk pasien yang sudah memiliki nomer rekam medis di RSUD Dr. Soedono Madiun. <br>
